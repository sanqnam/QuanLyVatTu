...
@Component({
  selector: 'app-phieu-cho-duyet',
  templateUrl: './phieu-cho-duyet.component.html',
  styleUrls: ['./phieu-cho-duyet.component.css']
})
export class PhieuChoDuyetComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    this.LoadPhieu(this.page, this.filter.size,this.idUser, this.sortOrder, 1, this.choose);
  }
  ...
  onTableDataChange (event: any){
    ...
    this.page = event;
    this.LoadPhieu(this.page, this.tableSize,this.idUser, this.sortOrder, 1,this.choose);    
  }
  filterSelect(){
